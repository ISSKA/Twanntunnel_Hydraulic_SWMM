...
> [!NOTE]  
> Q_Wasserhooliloch n'est pas calculé si Q_Twannbach_unten < (Q_Twannbach_Oben + Q_Fensterstollen). Idem, si au moins une des stations présente une lacune de mesures > 48 h, le calcul n'est pas réalisé.
